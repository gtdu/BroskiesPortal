<div class="pl-4 pr-4 mb-4">
    <form method="post">
        <div class="form-group">
            ...
            <input name="root_url" type="text" class="form-control" id="newUserEmail" aria-describedby="emailHelp" placeholder="/modules/doohickey" required value="<?php echo $item['root_url']; ?>">
        </div>
        <div class="form-group">
            <label for="newUserEmail">Icon URL</label>
            <input name="icon_url" type="text" class="form-control" id="newUserEmail" aria-describedby="emailHelp" placeholder="http://google.com/png.jpg" value="<?php echo $item['icon_url']; ?>">
        </div>
        <div class="form-group">
            ...
            <input name="levelNames" type="text" class="form-control" id="newUserName2" aria-describedby="emailHelp" placeholder="No Access, Pledge, Brother, Officer, Admin" value="<?php echo $item['levelNames']; ?>">
        </div>
        <div class="form-group">
