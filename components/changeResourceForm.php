...
<div class="pl-4 pr-4 mb-4">
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input name="link" type="url" class="form-control" id="newResourceLink" aria-describedby="aria" placeholder="http://drive.google.com" required value="<?php echo $item['link']; ?>">
        </div>
        <div class="form-group">
            <label for="newResourcePosition">Position</label>
            <input name="position" type="text" class="form-control" id="newResourcePosition" aria-describedby="aria" placeholder="Secretary" required value="<?php echo $item['position']; ?>">
        </div>
        <div class="form-group">
            <label for="newResourceDescription">Description</label>
            <input name="description" type="text" class="form-control" id="newResourceDescription" aria-describedby="aria" placeholder="2019-2020 Roll Book" value="<?php echo $item['description']; ?>">
        </div>
        <div class="form-group">
